...
import { createInvoice, deleteInvoice, getInvoice, listInvoices, updateInvoice } from "../lib/notaryApi";
...
export default function InvoiceGenerator() {
  ...
  useEffect(() => {
    loadHistory().catch((error) => setMessage(error.message || "Riwayat invoice gagal dimuat.")).finally(() => setLoading(false));
  }, []);
