  ...
  return (
    <article className="journal-card" role="link" tabIndex={0} aria-label={`Buka review PMA: ${article.title}`} onClick={openReview} onKeyDown={handleKeyDown}>
      <div className="journal-card-visual">
        <JournalArtwork article={article} />
        <span className="journal-image-badge">{isOriginal ? "PMA ORIGINAL / CONTEXT ART" : "PMA CONTEXT ART"}</span>
      </div>
...
function App() {
  ...
  if (path === "/profile") return <div className="site-shell"><div className="ambient ambient-one" /><div className="ambient ambient-two" /><div className="grid-overlay" /><AnimeEffects /><PageControls showBack /><Profile /><footer className="site-footer"><span>© 2026 PMA MEDIA YOGYAKARTA</span><span>PMA.WTF / DIGITAL CREATIVE HUB</span></div>;
