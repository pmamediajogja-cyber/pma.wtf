...
function Home() {
  ...
  const filteredDesigns =
    filter === "ALL" ? designs : designs.filter((d) => d.type === filter);
      ...
      <main id="top">
        <section className="hero section-wrap">
          <div className="hero-copy reveal">
            <div className="eyebrow">
              <span className="status-dot" /> DIGITAL CREATIVE / YOGYAKARTA
            </div>
            <h1>
              MAKE SOMETHING
              <br />
        ...
        <section id="designs" className="section-wrap section-block">
          <div className="section-heading">
            ...
            <p>
              Original graphic work, released as free downloads and premium
              digital products.
            </p>
          </div>
          <div className="design-toolbar">
            <div className="filter-label">
              FILTER / {filteredDesigns.length.toString().padStart(2, "0")}{" "}
              ITEMS
            </div>
            <div className="design-filters">
              {["ALL", "FREE", "PREMIUM"].map((option) => (
                <button
                  key={option}
                  className={
                    filter === option ? "filter-button active" : "filter-button"
                  }
        ...
        >
          ...
          <div className="service-list">
            {[
              ...
              <a href="#contact" className="service-row" key={s}>
                <span>0{i + 1}</span>
                <strong>{s}</strong>
                <b>↗</b>
              </a>
        ...
        >
          <div className="section-heading">
            ...
            <p>
              Notes on design, technology, creative work and building things
              online.
            </p>
          </div>
       ...
       <section className="section-wrap section-block about-section">
          <div className="about-label">
            <span className="section-index">04 / ABOUT</span>
            <span>PMA MEDIA YOGYAKARTA</span>
          </div>
  ...
  <div className="about-links">
    ...
    <a href="#About">View Profile ↗</a>
        ...
        <section id="contact" className="section-wrap contact-section">
          ...
          <a className="contact-email" href="pma.media.jogja@gmail.com">
            pma.media.jogja@gmail.com ↗
          </a>
          <div className="company-line">
            PT PMA MEDIA YOGYAKARTA · DIGITAL CREATIVE & TECHNOLOGY
          </div>
        </section>
      </main>
    </>
...
function App() {
  ...
  return (
    <div className="site-shell">
      ...
      {match ? <DesignDetail design={design} /> : <Home />}
